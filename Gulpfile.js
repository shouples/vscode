...
function handleBuildLog(level, log, handler) {
  ...
  // and src/clients/*, which are generated by openapi-generator-cli
  if (
    log.code === "CIRCULAR_DEPENDENCY" &&
    log.ids.every((id) => id.includes("node_modules") || id.includes("src/clients"))
  )
    return;
...
export async function apigen() {
  ...
  const clients = [
    ...
    [
      "src/clients/sidecar-openapi-specs/flink-artifacts.openapi.yaml",
